...
def get_classifications (value):
    ...
    body = {'displayName': 'Extracting custom text classification', 'analysisInput': {'documents': [{'id': '1', 'language': language, 'text':corpus}]}, 'tasks': [{'kind': 'CustomMultiLabelClassification','taskName': 'Multi Label Classification','parameters': {'project-name': project_name,'deployment-name': deployment}}]}
